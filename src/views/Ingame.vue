<template>
  <div>
      <button class="menu-button back-to-menu-button" @click="backToMenu()"></button>
      <undo-redo></undo-redo>
      <div v-if="getAIEnabled && playername == 'KI'" class="disabledMatchfield"></div>
      <div v-if="getAIEnabled && playername == 'KI'" class="disabledUndoRedo"></div>
      <div id="shutthebox-game" class="matchfield-container">
          <div class="text-large"><u>{{ playername }}</u> ist an der Reihe</div>
          <br>
